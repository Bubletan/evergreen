...
public class ItemTypesToJson {
    ...
    public static void main(String[] args) {
        ...
        List<ItemDefinition> list = (List<ItemDefinition>) xStream
                .fromXML(ItemDefinition.class
                        .getResourceAsStream("itemDefinitions.xml"));
        ...
        for (ItemDefinition def : list) {
            ...
            case "ARROWS":
                ...
                break;
            default:
                System.out.println("Unknown eq type: "
                        + def.getEquipmentType().toUpperCase());
            }
        ...
        for (Map.Entry<Integer, ItemType> entry : map.entrySet()) {
            ...
            try (PrintStream out = new PrintStream(new FileOutputStream(
                    "./data/config/item/" + entry.getKey() + ".json"))) {
                out.print(json);
            } catch (FileNotFoundException e) {
                e.printStackTrace();
            }
