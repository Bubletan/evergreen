...
import eg.net.game.out.codec.WeightAlteredPacketEncoder;
...
public enum OutboundAbstractGamePacketDeclaration {
    ...
    WEIGHT_ALTERED_PACKET(240, WeightAlteredPacket.class, WeightAlteredPacketEncoder.class),
    ...
    private <T extends AbstractGamePacket> OutboundAbstractGamePacketDeclaration(
            int packetType, Class<T> packetClass,
            Class<? extends AbstractGamePacketEncoder<T>> encoderClass) {
