...
public final class LoginRequest {
	...
	public LoginRequest(String username, String password, int usernameHash, int uid, IsaacCipher decodingCipher,
			IsaacCipher encodingCipher, boolean reconnecting, boolean lowMemory, int releaseNumber,
